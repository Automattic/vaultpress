...
class Jetpack_Connect_Options {
	...
	public static function get_option_names( $type = 'compact' ) {
		...
		return array(
			...
			'time_diff',                    // (int)    Offset between Jetpack server's clocks and this server's clocks. Jetpack Server Time = time() + (int) Jetpack_Connection_Options::get_option( 'time_diff' )
...
//		}
	...
	/**
	 * Gets all known options that are used by Jetpack and managed by Jetpack_Connection_Options.
	 *
	 * @since 5.4.0
	 *
	 ...
	 * @return array An array of all options managed via the Jetpack_Connection_Options class.
	 */
	...
	/**
	 * Get all options that are not managed by the Jetpack_Connection_Options class that are used by Jetpack.
	 *
	 * @since 5.4.0
	 *
	 * @return array
	 ...
	 * @since 5.4.0
	 *
	 * @return array array Associative array containing jp_options which are managed by the Jetpack_Connection_Options class and wp_options which are not.
	 */
	...
	static function delete_all_known_options() {
		...
		foreach ( (array) self::get_option_names( 'non-compact' ) as $option_name ) {
			Jetpack_Connection_Options::delete_option( $option_name );
		}
